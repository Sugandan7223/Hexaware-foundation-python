...
ALTER TABLE Pets ADD ShelterID INT DEFAULT 1;
...
INSERT INTO Pets (PetID, Name, Age, Breed, Type, AvailableForAdoption,OwnerID,ShelterName)
VALUES(1, 'Raja', 2, 'Labrador Retriever', 'Dog', 1,null,'Saranya Pet Haven'),
    (2, 'Meena', 1, 'Persian', 'Cat', 1,null,'Surya Animal Shelter'),
    (3, 'Krish', 3, 'Dachshund', 'Dog', 0,null,'Saranya Pet Haven');


INSERT INTO Shelters (ShelterID, Name, Location)
VALUES(1, 'Saranya Pet Haven', '789 Green Street'),
    (2, 'Surya Animal Shelter', '234 Palm Avenue');
...
VALUES(1, 'South Paws Adoption Day', '2024-03-15 12:00:00', 'Coconut Grove Park'),
    (2, 'Southern Tails Fair', '2024-04-10 10:00:00', 'Chennai Marina');


INSERT INTO Participants (ParticipantID, ParticipantName, ParticipantType, EventID)
VALUES (1, 'Saranya Pet Haven', 'Shelter', 1),
    (2, 'Karthik Raja', 'Adopter', 1),
    (3, 'Surya Animal Shelter', 'Shelter', 2);
